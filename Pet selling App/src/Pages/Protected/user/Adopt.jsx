      ...
      <section className="py-24 relative">
        {cart.length === 0 ? (
          <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto py-48">
            <h2 className="title font-manrope font-bold text-3xl md:text-4xl leading-10 mb-8 text-center text-black dark:text-pink-500">
              {auth?.token
                ? `Welcome ${auth.user.fullName}, For Adopting Process`
                : "Shopping Cart"}
            </h2>
            <p className="font-normal text-center leading-7 text-gray-500 dark:text-slate-300 mb-6">
              Your Adopt Wishlist is Empty For right now, Please Visit Pets Page
              to Continue Adoptation
            </p>
            <center>
              <button
          ...
          <h2 className="title font-manrope font-bold text-3xl leading-10 mb-3 text-center text-black dark:text-pink-500">
                  {auth?.token
                    ? `Welcome ${auth.user.fullName}, For Adopting Process`
                    : "Shopping Cart"}
                </h2>
                <p className="font-normal text-center leading-7 text-gray-500 dark:text-slate-300 mb-3">
                  Please Complete Checkout Process To Adopt New Family Member
                  Today : )
                </p>
                  ...
                  <div className="rounded-3xl border-2 border-gray-200 p-4 lg:p-8 grid grid-cols-12 mb-8 max-lg:max-w-lg max-lg:mx-auto gap-y-4 ">
                    ...
                    <div className="col-span-12 lg:col-span-10 detail w-full lg:pl-3">
                      <div className="flex items-center justify-between w-full mb-4">
                        <h5 className="font-manrope font-bold text-2xl leading-9 text-gray-900 dark:text-lime-100">
                          {i.breed}
                        </h5>
                        <button
                          onClick={() => removeCart(i._id)}
                      ...
                      <p className="font-normal text-base leading-7 text-gray-500 dark:text-slate-300 mb-6">
                        {i.details}{" "}
                      </p>
