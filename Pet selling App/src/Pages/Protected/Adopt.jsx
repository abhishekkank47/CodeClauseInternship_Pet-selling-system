    ...
    <>
      <section className="py-24 relative">
        <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
          <h2 className="title font-manrope font-bold text-4xl leading-10 mb-8 text-center text-black dark:text-pink-500">
            Shopping Cart
          </h2>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-center justify-between lg:px-6 pb-6 border-b border-gray-200 max-lg:max-w-lg max-lg:mx-auto">
            ...
            <div className="flex items-center justify-between gap-5 ">
              <h6 className="font-manrope font-bold text-3xl lead-10 text-green-500">
                $440
              </h6>
            </div>
          </div>
          <div className="max-lg:max-w-lg max-lg:mx-auto">
            ...
            <button  className="rounded-full py-4 px-6 bg-green-500 text-black font-semibold text-lg w-full text-center transition-all duration-500 hover:bg-blue-500 ">
              <Link to='/adopt-checkout'>Checkout</Link>
            </button>
          </div>
        </div>
      </section>
