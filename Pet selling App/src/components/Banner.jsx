        ...
        <div className="w-full md:w-1/2 md:mt-32 mt-10 md:order-2 order-1">
          <div className="space-y-12">
            ...
            <p className="text-xl">
              ...
              et molestiae fugit corrupti, hic vero.
              adipisci molestias voluptates ut! Commodi iusto ratione quo? Ipsam
              et molestiae fugit corrupti, hic vero.
              adipisci molestias voluptates ut! Commodi iusto ratione quo? Ipsam
              et molestiae fugit corrupti, hic vero.
            ...
            <div className="flex justify-center">
              <label className="input input-bordered flex items-center gap-2 w-40 md:w-60">
                <svg
              ...
              <button className="btn btn-active btn-secondary mx-3">
                Register
              </button>
            </div>
          </div>
